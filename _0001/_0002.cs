...
internal static class \u0002
{
  ...
  public static void \u0002([In] int obj0)
  {
    ...
    try
    {
      typeFromHandle = Type.GetTypeFromHandle(\u0001.\u0002.\u0001.ResolveTypeHandle(33554433 /*0x02000001*/ + obj0));
    }
    catch
    {
      return;
    ...
    foreach (FieldInfo field in typeFromHandle.GetFields(BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.GetField))
    {
      ...
      try
      {
        methodFromHandle = (MethodInfo) MethodBase.GetMethodFromHandle(\u0001.\u0002.\u0001.ResolveMethodHandle(num + 167772161 /*0x0A000001*/));
      }
      catch
      {
        continue;
